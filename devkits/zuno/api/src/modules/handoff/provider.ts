...
import { ZunoHandoffService } from "./handoff-service";
import { ZunoHandoffStore } from "./handoff-store";

export class ZunoHandoffProvider implements ModuleProvider {
  constructor(private readonly databasePath: string) {}

  readonly manifest = { id: "zuno.handoff", owner: "devkits/zuno/api/modules/handoff", version: "1.0.0", dependencies: ["zuno.foundation"], contracts: ["zuno.handoff"], events: { published: [], consumed: [] } };
