...
It belongs to ZCode's product architecture, not the assistant's personal memory folder.

## Ownership and sources of truth

The ZCode knowledge module owns documents, versions, review state, provenance, and retrieval metadata.
...
`storage/apps/private/zcode/knowledge/`, scoped by authorized workspace and project.
