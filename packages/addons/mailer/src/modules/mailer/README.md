# Mailer Backend Module

This module owns the Email delivery and mailbox workflows domain boundary.

## Contract

The module exports its provider through the package root and exposes versioned contract \`mailer.v1\`. Its API boundary is defined in \`src/api.ts\`.
