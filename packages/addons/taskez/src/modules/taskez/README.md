# Taskez Backend Module

This module owns the Task assignment and execution tracking domain boundary.

## Contract

The module exports its provider through the package root and exposes versioned contract \`taskez.v1\`. Its API boundary is defined in \`src/api.ts\`.
