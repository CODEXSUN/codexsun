# Wikiz Backend Module

This module owns the Structured internal knowledge domain boundary.

## Contract

The module exports its provider through the package root and exposes versioned contract \`wikiz.v1\`. Its API boundary is defined in \`src/api.ts\`.
