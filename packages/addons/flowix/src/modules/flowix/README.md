# Flowix Backend Module

This module owns the Cross-add-on workflow automation domain boundary.

## Contract

The module exports its provider through the package root and exposes versioned contract \`flowix.v1\`. Its API boundary is defined in \`src/api.ts\`.
