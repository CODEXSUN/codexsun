# Calendy Backend Module

This module owns the Scheduling, availability, and reminders domain boundary.

## Contract

The module exports its provider through the package root and exposes versioned contract \`calendy.v1\`. Its API boundary is defined in \`src/api.ts\`.
