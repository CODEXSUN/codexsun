# Notez Backend Module

This module owns the Personal and team notes domain boundary.

## Contract

The module exports its provider through the package root and exposes versioned contract \`notez.v1\`. Its API boundary is defined in \`src/api.ts\`.
