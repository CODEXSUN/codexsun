# Notifyz Backend Module

This module owns the Central user and system notifications domain boundary.

## Contract

The module exports its provider through the package root and exposes versioned contract \`notifyz.v1\`. Its API boundary is defined in \`src/api.ts\`.
