# Socialix Backend Module

This module owns the Social content and publishing domain boundary.

## Contract

The module exports its provider through the package root and exposes versioned contract \`socialix.v1\`. Its API boundary is defined in \`src/api.ts\`.
