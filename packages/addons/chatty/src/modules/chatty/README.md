# Chatty Backend Module

This module owns the Team conversations and message history domain boundary.

## Contract

The module exports its provider through the package root and exposes versioned contract \`chatty.v1\`. Its API boundary is defined in \`src/api.ts\`.
