# Gitflow Backend Module

This module owns the Repository collaboration workflows domain boundary.

## Contract

The module exports its provider through the package root and exposes versioned contract \`gitflow.v1\`. Its API boundary is defined in \`src/api.ts\`.
