...
import { designSystemCategories } from '../../design-system'
  ...
  return (
    <header className="grid gap-6 border-b pb-8 lg:grid-cols-[minmax(0,1fr)_auto] lg:items-end">
      ...
      <div className="flex flex-wrap gap-2">
        <Button nativeButton={false} render={<a href="/ui?layout=mdi-main" />} variant="outline">
          <LayoutTemplate /> Layouts
        </Button>
        <Button nativeButton={false} render={<a href="/ui?block=table" />}>
