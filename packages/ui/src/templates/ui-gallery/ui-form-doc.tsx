...
import { FormBlock, FormLookupField, type FormBlockTab } from '../../blocks/form'
...
export function UiFormDocumentation() {
  ...
  return (
    <UiTemplatePage
      ...
      name="Form"
      navigation={{
        next: { href: '/ui?component=accordion', name: 'Accordion' },
        previous: { href: '/ui?block=table', name: 'Table' },
      }}
      preview={
        <>
          <FormBlock
