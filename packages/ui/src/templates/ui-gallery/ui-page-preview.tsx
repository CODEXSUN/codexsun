import { LoginPage, PasswordForgotPage, RegisterPage } from '../../blocks/auth'
import { NotificationCenterPage } from '../../blocks/notifications'
...
export function UiPagePreview({ page }: { page: UiPageDoc }) {
  ...
  if (page.family.id === 'forgot-password') {
    return <PasswordForgotPage backHref="/ui?page=login-v1" embedded onSubmit={() => undefined} />
  }
