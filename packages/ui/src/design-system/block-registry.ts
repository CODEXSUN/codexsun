...
export const designSystemBlocks: readonly DesignSystemBlockDefinition[] = [
  ...
  },
  {
    defaultVariantId: 'default',
    description:
      'A drag-and-drop file upload zone with type/size validation and progress tracking.',
    id: 'dropzone',
    name: 'File Dropzone',
  ...
  },
  {
    defaultVariantId: 'default',
    description:
      'A multi-tier pricing table with monthly/annual interval toggle and feature lists.',
    id: 'pricing',
    name: 'Pricing Table',
  ...
  },
  {
    defaultVariantId: 'default',
    description:
      'An interactive storefront slide-over cart drawer with quantity stepper and shipping threshold meter.',
    id: 'cart',
  ...
  },
  {
    defaultVariantId: 'default',
    description:
      'A multi-step checkout wizard covering shipping destination, payment method, and order review.',
    id: 'checkout',
  ...
  },
  {
    defaultVariantId: 'default',
    description:
      'A side-by-side product comparison matrix with spec rows and difference highlighting.',
    id: 'comparison',
  ...
  },
  {
    defaultVariantId: 'default',
    description:
      'A promotional coupon wallet with voucher cards, instant code copy, and applied discount management.',
    id: 'coupon-wallet',
    name: 'Coupon Wallet',
  ...
  },
  {
    defaultVariantId: 'default',
    description:
      'A visual shipment milestone timeline with courier details and live delivery status.',
    id: 'delivery-tracker',
  ...
  },
  {
    defaultVariantId: 'default',
    description:
      'A checkout payment method selector covering saved cards with CVV entry, UPI, wallets, and COD.',
    id: 'payment-methods',
  ...
  },
  {
    defaultVariantId: 'default',
    description:
      'A historical price trend visualization with lowest/peak markers and price drop notifications.',
    id: 'price-history',
  ...
  },
  {
    defaultVariantId: 'default',
    description:
      'An aggregate rating breakdown, verified customer reviews list, and write-review form.',
    id: 'reviews',
  ...
  },
  {
    defaultVariantId: 'default',
    description:
      'A saved items wishlist grid with stock availability indicators and quick move-to-cart actions.',
    id: 'wishlist',
    name: 'Wishlist Grid',
