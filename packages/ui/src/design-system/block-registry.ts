...
export const designSystemBlocks: readonly DesignSystemBlockDefinition[] = [
  ...
  {
    defaultVariantId: 'default',
    description: 'A multi-column storefront and content footer with newsletter subscribe, social links, and payment badges.',
    id: 'footer',
    name: 'Site Footer',
  ...
  {
    defaultVariantId: 'default',
    description: 'An editorial blog suite featuring post cards (standard, horizontal, compact) and rich article reading layout.',
    id: 'blog',
    name: 'Blog & Editorial',
