...
- [x] Z-1203: Persistent Chat Idea Workspace
  ...
  - Owner: `devkits/zetro/api/modules/chat` and `devkits/zetro/web`.
...
- [x] Z-1204: Local Codex Connection Status and Device-Code Boundary
  ...
  - Owner: `devkits/zetro/api/modules/chat` and `packages/ui` connection blocks.
...
- [x] Z-1205: Final Brief and Handover Records
  - Status: complete on 2026-09-19.
  - Owners: `devkits/zetro/api/modules/brief`,
    `devkits/zetro/api/modules/task`, and the shared UI handover workspace.
...
- [x] Z-1206: Final Brief Readiness and Zuno Delivery
  ...
  - Owners: `packages/zetro-contracts`, `devkits/zetro/api/modules/task`,
    `devkits/zuno/api/modules/handoff`, and the shared handover workspace.
