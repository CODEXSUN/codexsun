...
Read the [Orship orchestration plan](orship-planning.md) and [Orship task
register](orship-task.md) before starting Orship work.

Read the [Zetro planning](zetro-planning.md) and [Zetro task register](zetro-task.md)
