...
| Any component, form, field control, block, table, layout, template, variant, or UI gallery page                | [UI Template Pages](ui-template-pages.md)         | [Web UI](web-ui.md) for the consuming application                                      |
...
| [UI Template Pages](ui-template-pages.md)         | All reusable web UI ownership and its gallery documentation            |
