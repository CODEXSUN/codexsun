...
- Migration: clean-database dry run applied 29 migrations and verified 32 ledger records with zero mismatches; see `2026-09-24-qcafe-migration-dryrun.md`.
...
- Browser end-to-end flows (Playwright) were not run; no live deployment was started.
- MariaDB execution paths were not run; SQLite and MariaDB share the application-level contract by design, and MariaDB tests stay opt-in.
