...
The active `zetro.supervisor.api` module is version `0.2.1`.
...
| ---------------------------- | ------- | --------- | ----------- | --------------------------------------------------------------------------------- |
| `zetro.codex-connection.api` | 0.9.0   | Zetro API | Active      | [Codex connection](../../apps/zetro/api/src/modules/codex-connection/README.md)   |
| `zetro.projects.api`         | 0.5.0   | Zetro API | Active      | [Projects API](../../apps/zetro/api/src/modules/projects/README.md)               |
| `zetro.chat.api`             | 0.15.0  | Zetro API | Active      | [Chat API](../../apps/zetro/api/src/modules/chat/README.md)                       |
...
| `zetro.agent-chat.web`       | 0.13.0  | Zetro web | Active      | [Agent Chat web](../../apps/zetro/web/src/modules/agent-chat/README.md)           |
