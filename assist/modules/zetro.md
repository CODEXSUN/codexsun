...
| ---------------------------- | ------- | --------- | ----------- | --------------------------------------------------------------------------------- |
| `zetro.codex-connection.api` | 0.10.1  | Zetro API | Active      | [Codex connection](../../apps/zetro/api/src/modules/codex-connection/README.md)   |
| `zetro.projects.api`         | 0.5.0   | Zetro API | Active      | [Projects API](../../apps/zetro/api/src/modules/projects/README.md)               |
| `zetro.chat.api`             | 0.16.0  | Zetro API | Active      | [Chat API](../../apps/zetro/api/src/modules/chat/README.md)                       |
...
| `zetro.agent-chat.web`       | 0.13.1  | Zetro web | Active      | [Agent Chat web](../../apps/zetro/web/src/modules/agent-chat/README.md)           |
| `zetro.project-tasks.web`    | 0.5.0   | Zetro web | Active      | [Project Tasks web](../../apps/zetro/web/src/modules/project-tasks/README.md)     |
| `zetro.settings.web`         | 0.5.0   | Zetro web | Active      | [Settings web](../../apps/zetro/web/src/modules/settings/README.md)               |
