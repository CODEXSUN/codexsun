...
| `zetro.chat.api`        | 2.3.0   | Zetro API      | Active      | [Chat API](../../apps/zetro/api/src/modules/chat/README.md)               |
| `zetro.agent-tasks.api` | 1.0.0   | Zetro API      | Active      | [Agent Tasks API](../../apps/zetro/api/src/modules/agent-tasks/README.md) |
| `zetro.providers.web`   | 1.3.0   | Zetro web      | Active      | [Provider settings](../../apps/zetro/web/src/modules/providers/README.md) |
| `zetro.shell.web`       | 2.6.0   | Zetro web      | Active      | [Shell](../../apps/zetro/web/src/modules/shell/README.md)                 |
| `zetro.agent-tasks.web` | 1.0.0   | Zetro web      | Active      | [Agent Tasks web](../../apps/zetro/web/src/modules/agent-tasks/README.md) |
