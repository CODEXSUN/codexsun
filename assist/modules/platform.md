...
| `event-runtime`  | `1.0.0`                   | `platform` | Active | [Event Runtime API](../../apps/platform/api/src/modules/event-runtime/README.md)   | None                                                                   |
| `identity`       | `1.3.0` API / `1.1.2` web | `platform` | Active | [Identity API](../../apps/platform/api/src/modules/identity/README.md)             | [Identity web](../../apps/platform/web/src/modules/identity/README.md) |
