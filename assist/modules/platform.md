...
| `identity`       | `1.1.0` | `platform` | Active | [Identity API](../../apps/platform/api/src/modules/identity/README.md)             | [Identity web](../../apps/platform/web/src/modules/identity/README.md)   |
...
| `ui-gallery`     | `1.2.0` | `platform` | Active | None                                                                               | [UI workspace](../../apps/platform/web/src/modules/ui-gallery/README.md) |
