...
U-604 adds the public `ContentSection`, `DashboardPage`, and `SettingsPage` composition exports. `MainWorkspace` is the default workspace template. U-605 wires the Platform web host through these public exports. U-606 adds the standalone `../../devkits` gallery, with preview-only theme and density controls.
