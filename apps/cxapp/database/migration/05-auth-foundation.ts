...
export const coreAuthFoundationMigration = defineDatabaseMigration({
  ...
  up: async ({ database }) => {
    ...
    await queryDatabase.schema
      .createTable(cxappTableNames.authPermissions)
      .ifNotExists()
    ...
    await queryDatabase.schema
      .createTable(cxappTableNames.authRoles)
      .ifNotExists()
      .addColumn("id", "varchar(191)", (column) => column.primaryKey())
    ...
    await queryDatabase.schema
      .createTable(cxappTableNames.authUsers)
      .ifNotExists()
      .addColumn("id", "varchar(191)", (column) => column.primaryKey())
    ...
    await queryDatabase.schema
      .createTable(cxappTableNames.authUserRoles)
      .ifNotExists()
      .addColumn("id", "varchar(191)", (column) => column.primaryKey())
      ...
      .addForeignKeyConstraint(
        "cxapp_auth_user_roles_user_fk",
        ["user_id"],
        cxappTableNames.authUsers,
        ["id"]
      )
      .addForeignKeyConstraint(
        "cxapp_auth_user_roles_role_fk",
        ["role_id"],
        cxappTableNames.authRoles,
        ["id"]
      )
      .execute()

    await queryDatabase.schema
      .createTable(cxappTableNames.authRolePermissions)
      .ifNotExists()
      .addColumn("id", "varchar(191)", (column) => column.primaryKey())
      .addColumn("role_id", "varchar(191)", (column) => column.notNull())
      ...
      .addForeignKeyConstraint(
        "cxapp_auth_role_permissions_role_fk",
        ["role_id"],
        cxappTableNames.authRoles,
        ["id"]
      )
      .addForeignKeyConstraint(
        "cxapp_auth_role_permissions_permission_fk",
        ["permission_id"],
        cxappTableNames.authPermissions,
        ["id"]
      )
      .execute()
  },
