...
export const monorepoPractices = [
  ["One install", "Install dependencies at the repository root. Keep one lockfile and one node_modules folder."],
  [
    "Clear workspace edges",
    "Applications do not import each other’s private source. Shared packages expose public contracts.",
  ],
  ["Independent ownership", "Each application keeps its routes, modules, migrations, and operational records."],
  [
    "Selected assembly",
