...
export const operationsSeed: SeedMap = {
  ...
  storefrontTemplates: [
    ...
    defineItem("storefront-template:home-cta", { code: "home-cta", name: "Home CTA", sort_order: 30, badge_text: "Commerce scaffold", title: "Prepare catalog, checkout, and order operations inside one suite.", description: "This CTA now points at the ecommerce scaffold workspace while the commerce rebuild is in progress.", cta_primary_label: "Open commerce workspace", cta_primary_href: "/dashboard/apps/ecommerce", cta_secondary_label: "Review app structure", cta_secondary_href: "/dashboard/apps/ecommerce/structure", icon_key: "sparkles", theme_key: "cta" }),
  ],
  sliderThemes: [
