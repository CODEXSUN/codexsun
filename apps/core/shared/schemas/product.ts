...
export const productStorefrontSchema = z.object({
  ...
  discoveryBoardEnabled: z.boolean().optional().default(false),
  discoveryBoardOrder: z.number().int().optional().default(0),
  visualStripEnabled: z.boolean().optional().default(false),
  visualStripOrder: z.number().int().optional().default(0),
...
export const productStorefrontInputSchema = z.object({
  ...
  discoveryBoardEnabled: z.boolean().optional().default(false),
  discoveryBoardOrder: z.number().int().default(0),
  visualStripEnabled: z.boolean().optional().default(false),
  visualStripOrder: z.number().int().default(0),
...
export const productBulkEditPayloadSchema = z.object({
  ...
  discoveryBoardEnabled: z.boolean().optional(),
  discoveryBoardOrder: z.number().int().optional(),
  visualStripEnabled: z.boolean().optional(),
  visualStripOrder: z.number().int().optional(),
