...
export const commonModuleSummarySchema = z.object({
  key: commonModuleKeySchema,
  label: z.string().min(1),
...
export const commonModuleSummaryListResponseSchema = z.object({
  items: z.array(commonModuleSummarySchema),
})
...
export type CommonModuleMetadataColumn = z.infer<
  typeof commonModuleMetadataColumnSchema
>
export type CommonModuleMetadata = z.infer<typeof commonModuleMetadataSchema>
export type CommonModuleSummary = z.infer<typeof commonModuleSummarySchema>
export type CommonModuleListResponse = z.infer<typeof commonModuleListResponseSchema>
export type CommonModuleRecordResponse = z.infer<
  typeof commonModuleRecordResponseSchema
>
...
>
export type CommonModuleSummaryListResponse = z.infer<
  typeof commonModuleSummaryListResponseSchema
>
