...
export function toProductFormValues(product: Product): ProductFormValues {
  ...
  return {
    ...
    discoveryBoardOrder: product.storefront?.discoveryBoardOrder ?? product.discoveryBoardOrder,
    visualStripEnabled: product.visualStripEnabled,
    visualStripOrder: product.storefront?.visualStripOrder ?? product.visualStripOrder,
    ...
    storefront: product.storefront
      ...
      : {
          ...
          featureSectionEnabled: product.featureSectionEnabled,
          discoveryBoardEnabled: product.discoveryBoardEnabled,
          discoveryBoardOrder: product.discoveryBoardOrder,
          visualStripEnabled: product.visualStripEnabled,
          visualStripOrder: product.visualStripOrder,
          featureSectionOrder: 0,
          isNewArrival: product.isNewArrival,
          isBestSeller: product.isBestSeller,
          isFeaturedLabel: product.isFeaturedLabel,
