...
Work only inside apps/qcafe unless a public platform or framework contract requires a reviewed change.

Keep product modules owned by Q Cafe. Use shared UI, identity, and platform contracts instead of copying them.
