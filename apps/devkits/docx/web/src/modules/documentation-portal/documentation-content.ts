...
export const portalDocuments: PortalDocument[] = [
  {
    ...
    path: "apps/devkits/docx/web/src/modules/documentation-portal/README.md",
  ...
  },
  {
    ...
    path: "apps/devkits/docx/web/src/modules/documentation-portal/authoring-workflow.md",
  ...
  },
  {
    ...
    path: "apps/devkits/docx/web/src/modules/documentation-portal/portal-experience.md",
