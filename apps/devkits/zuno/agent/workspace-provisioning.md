...
- Install the CXForge image with `apps/cxforge/.container/cxforge-setup.sh`.
...
node --import tsx apps/devkits/zuno/api/src/modules/cxforge/test/workspace-live.ts
```
