...
import { registerWorkspaceRoutes } from "./modules/cxforge/workspace-routes.js";
...
// The former fixed worker record is incompatible with container-per-workspace.
portalStore.removeLegacyServer(config.cxforgeUrl);
