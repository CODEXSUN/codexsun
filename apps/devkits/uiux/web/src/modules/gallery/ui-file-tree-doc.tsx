    ...
    children: [
      {
        children: [
          { id: 'app-ts', name: 'app.ts', path: 'apps/platform/api/src/app.ts', type: 'file' },
          {
            id: 'server-ts',
            name: 'server.ts',
            path: 'apps/platform/api/src/server.ts',
            type: 'file',
          },
          {
            id: 'config-ts',
            name: 'config.ts',
            path: 'apps/platform/api/src/config.ts',
            type: 'file',
          },
          {
            children: [
              {
                ...
                path: 'apps/platform/api/src/modules/identity.module.ts',
                type: 'file',
              },
              {
                id: 'sys-mod',
                name: 'system.module.ts',
                path: 'apps/platform/api/src/modules/system.module.ts',
                type: 'file',
              },
            ],
            id: 'modules-dir',
