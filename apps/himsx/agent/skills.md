...
Work only inside apps/himsx unless a public platform or framework contract requires a reviewed change.

Keep product modules owned by HIMSX. Use shared UI, identity, and platform contracts instead of copying them.
