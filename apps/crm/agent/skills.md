...
Work only inside apps/crm unless a public platform or framework contract requires a reviewed change.

Keep product modules owned by CRM. Use shared UI, identity, and platform contracts instead of copying them.
