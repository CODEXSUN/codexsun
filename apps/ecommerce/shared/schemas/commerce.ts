...
import { storefrontOrderSchema } from "./storefront.js"
...
export const commerceInvoiceStatusSchema = z.enum([
  "draft",
  "issued",
  "paid",
  "cancelled",
...
export const commerceOrderWorkflowListResponseSchema = z.object({
  items: z.array(commerceOrderWorkflowSchema),
})
...
export type CommerceOrderEventType = z.infer<
  typeof commerceOrderEventTypeSchema
>
export type CommerceShipmentStatus = z.infer<
  typeof commerceShipmentStatusSchema
>
export type CommerceInvoiceStatus = z.infer<
  typeof commerceInvoiceStatusSchema
>
...
export type CommerceShipmentEvent = z.infer<
  typeof commerceShipmentEventSchema
>
...
export type AccountingVoucherLine = z.infer<
  typeof accountingVoucherLineSchema
>
export type AccountingVoucher = z.infer<typeof accountingVoucherSchema>
export type CommerceOrderWorkflow = z.infer<
  typeof commerceOrderWorkflowSchema
>
export type CommerceOrderSummary = z.infer<typeof commerceOrderSummarySchema>
export type CommerceOrderListResponse = z.infer<
  typeof commerceOrderListResponseSchema
>
export type CommerceOrderWorkflowResponse = z.infer<
  typeof commerceOrderWorkflowResponseSchema
>
export type CommerceOrderWorkflowListResponse = z.infer<
  typeof commerceOrderWorkflowListResponseSchema
>
export type CommerceWorkflowActionPayload = z.infer<
  typeof commerceWorkflowActionPayloadSchema
>
export type PrintableDocumentResponse = z.infer<
  typeof printableDocumentResponseSchema
>
