...
export function Storefront() {
  return (
    ...
    />
      ...
      usageDescription={
        <p>
          Dedicated e-commerce storefront header featuring top promotional strip with free shipping
          progress meter, autocomplete live search, category megamenu flyout, wishlist count, and
