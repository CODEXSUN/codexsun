...
export const portalDocuments: PortalDocument[] = [
  {
    ...
    path: "apps/docx/web/src/modules/documentation-portal/README.md",
  ...
  },
  {
    ...
    path: "apps/docx/web/src/modules/documentation-portal/authoring-workflow.md",
  ...
  },
  {
    ...
    path: "apps/docx/web/src/modules/documentation-portal/portal-experience.md",
