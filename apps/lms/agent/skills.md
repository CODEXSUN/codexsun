...
Work only inside apps/lms unless a public platform or framework contract requires a reviewed change.

Keep product modules owned by LMS. Use shared UI, identity, and platform contracts instead of copying them.
