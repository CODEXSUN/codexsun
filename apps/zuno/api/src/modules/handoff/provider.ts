...
export class ZunoHandoffProvider implements ModuleProvider {
  ...
  readonly manifest = { id: "zuno.handoff", owner: "apps/zuno/api/modules/handoff", version: "1.0.0", dependencies: ["zuno.foundation"], contracts: ["zuno.handoff"], events: { published: [], consumed: [] } };
