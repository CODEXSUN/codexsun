...
export default defineConfig(({ mode }) => {
  ...
  return {
    ...
    define: {
      ...
      'import.meta.env.VITE_APP_TARGET': JSON.stringify(frontendTarget),
    ...
    resolve: {
      alias: {
        ...
        '@ecommerce-domain': path.resolve(import.meta.dirname, '../../ecommerce/domain/src'),
