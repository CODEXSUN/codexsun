...
import type { Task } from "@ui/app/roadmap/page";

export const roadmap: Task[] = [
  {
    title: "More customized codexsun UI Components",
    description:
  ...
  {
    title: "20+ Premium codexsun UI Blocks",
    description:
  ...
  {
    title: "Features section codexsun UI Blocks",
    description:
  ...
  {
    title: "30+ Premium codexsun UI Blocks",
    description:
  ...
  {
    title: "19 Customized codexsun UI Components",
    description:
  ...
  },
  {
    ...
    description:
      "A launch of essential components and blocks to get you started with codexsun UI Blocks.",
