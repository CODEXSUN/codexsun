...
import { components } from "@ui/description/app-sidebar";
...
const footerSections = [
  ...
  },
  {
    ...
    links: [
      {
        title: "codexsun UI Blocks Pro",
        href: "https://pro.codexsunui-blocks.com/",
      },
      {
        title: "basecn",
        ...
        <div className="grid grid-cols-2 gap-x-8 gap-y-10 px-6 py-12 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-7 xl:px-0">
          <div className="col-span-full lg:col-span-2">
            ...
            <p className="mt-4 text-muted-foreground">
              A collection of customized codexsun UI blocks and components, ready
