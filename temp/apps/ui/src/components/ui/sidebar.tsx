...
function Sidebar({
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "fixed top-(--sidebar-top,0px) bottom-0 z-10 hidden h-[calc(100svh-var(--sidebar-top,0px))] w-(--sidebar-width) transition-[left,right,top,width] duration-200 ease-linear md:flex",
          side === "left"
