...
import { blockCategories } from "@ui/blocks";
...
export default function BlockDetails() {
  return (
    <section className="dark:prose-invert prose mx-auto mt-12 prose-h2:text-3xl prose-li:text-xl prose-p:text-xl prose-li:leading-loose prose-p:leading-loose prose-h2:tracking-tight">
      <h2 id="what-is-codexsun-ui-blocks-">What is codexsun UI Blocks?</h2>
      <p>
        ...
        <strong>codexsun UI Blocks</strong> is an innovative platform that
        provides developers with a vast collection of{" "}
        <strong>codexsun UI components and blocks</strong>, making it easier to
      ...
      <hr />
      <h2 id="how-codexsun-ui-blocks-works">How codexsun UI Blocks Works</h2>
      <p>
        codexsun UI Blocks is designed to be a{" "}
        <strong>one-stop solution for developers</strong> looking for
        high-quality, ready-to-use components built with{" "}
        <strong>codexsun UI, Radix UI, and Tailwind CSS</strong>. The platform
        allows users to:
      </p>
      <ol>
        <li>
      ...
      <hr />
      <h2 id="benefits-of-using-codexsun-ui-blocks">
        Benefits of Using codexsun UI Blocks
      </h2>
      <h3 id="1-saves-development-time-">
        1. <strong>Saves Development Time</strong>
      </h3>
      <p>
        Building UI components from scratch can be time-consuming. With codexsun
      ...
      <h3 id="3-consistent-design-system-">
        3. <strong>Consistent Design System</strong>
      </h3>
      <p>
        Since all blocks are based on codexsun UI and Radix UI, they maintain a
        consistent design language, ensuring a professional look across
        different UI elements.
      </p>
      <h3 id="4-optimized-for-performance-">
      ...
      <h3 id="5-beginner-friendly-">
        5. <strong>Beginner-Friendly</strong>
      </h3>
      <p>
        Even developers new to codexsun UI can leverage these blocks without deep
        knowledge of Radix UI, making it an excellent resource for beginners and
        experienced developers alike.
      </p>
      <h3 id="6-fully-responsive">6. Fully Responsive</h3>
      <p>
        All the blocks are fully responsive, providing a seamless user
        experience.
      </p>
      <h3 id="7-theme-support">7. Theme Support</h3>
      <p>
        ...
        codexsun UI variables.
      </p>
      <hr />
      <h2 id="types-of-blocks-available">Types of Blocks Available</h2>
      <p>
        codexsun UI Blocks provides a diverse collection of UI blocks, covering
      ...
      <hr />
      <h2 id="how-to-use-codexsun-ui-blocks">How to Use codexsun UI Blocks</h2>
      <p>Using codexsun UI Blocks in your project is a simple process:</p>
      <ol>
        <li>
          <p>
      ...
      <p>
        ...
        <strong>codexsun UI, Tailwind CSS, and Radix UI</strong> are installed in
        your project.
      </p>
      <hr />
      <h2 id="conclusion">Conclusion</h2>
      <p>
        <strong>codexsun UI Blocks</strong> is a game-changer for developers
      ...
      <p>
        ...
        <strong>premium UI components</strong>, codexsun UI Blocks is the perfect
