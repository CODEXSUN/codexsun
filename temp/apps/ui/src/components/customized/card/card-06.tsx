...
import { Card, CardContent, CardFooter, CardHeader } from "@ui/registry/ui/card";
import {
  Item,
  ItemActions,
  ItemContent,
      ...
      <CardHeader className="-mr-1 flex flex-row items-center justify-between py-2.5">
        <Item className="w-full gap-2.5 p-0">
          ...
          <ItemContent className="gap-0">
            <ItemTitle>codexsun</ItemTitle>
            <ItemDescription className="text-xs">@codexsun</ItemDescription>
          </ItemContent>
