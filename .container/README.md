...
npm.cmd run runtime:start -- main-development
...
Production Node services force structured JSON logs. Set `OTEL_SDK_DISABLED=false` and an OTLP endpoint in `environment.env` when the deployment has a collector.
...
- [2026-09-08 Container source root](../assist/records/platform/2026-09-08-container-source-root.md)
