...
Work only inside core/platforms unless a public platform or framework contract requires a reviewed change.

Keep product modules owned by Platform. Use shared UI, identity, and platform contracts instead of copying them.
