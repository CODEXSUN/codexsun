...
const services = {
  ...
  'zetro-web': {
    ...
    defaultPort: 6060,
    hostKey: 'ZETRO_WEB_HOST',
    label: 'Zetro web',
    portKey: 'ZETRO_WEB_PORT',
    healthPath: '/',
    prepareWorkspaces: ['@codexsun/zetro-contracts', '@codexsun/ui'],
  },
  'zetro-api': {
    ...
    defaultPort: 6050,
    hostKey: 'ZETRO_API_HOST',
    label: 'Zetro API',
    portKey: 'ZETRO_API_PORT',
    healthPath: '/health',
    prepareWorkspaces: ['@codexsun/zetro-contracts', '@codexsun/platform-core-api'],
  },
  'agent-crew-api': {
