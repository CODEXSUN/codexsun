...
const moduleRoots = [
  {
    app: "mail-api",
    path: join(process.cwd(), "..", "mail", "api", "src", "modules")
  },
  {
    app: "billing-api",
    path: join(process.cwd(), "..", "billing", "api", "src", "modules")
  },
  {
    app: "core-api",
...
const webModuleRoots = [
  {
    app: "mail-web",
    path: join(process.cwd(), "..", "mail", "web", "src", "modules")
  },
  {
    app: "billing-web",
    path: join(process.cwd(), "..", "billing", "web", "src", "modules")
  },
  {
    app: "core-web",
