...
const services =
  stackName === 'docs' ? docsServices : stackName === 'zetro' ? zetroServices : platformServices

if (!['platform', 'docs', 'zetro'].includes(stackName))
  throw new Error('Use "platform", "docs", or "zetro" as the stack name.')
