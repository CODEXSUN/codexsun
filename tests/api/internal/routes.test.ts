...
test("internal route registry includes the frappe connector endpoints", () => {
  ...
  assert.ok(routePaths.includes("GET /internal/v1/frappe/observability"))
  assert.ok(routePaths.includes("GET /internal/v1/frappe/transactions/reconciliation-queue"))
  assert.ok(routePaths.includes("POST /internal/v1/frappe/transactions/replay"))
  assert.ok(routePaths.includes("POST /internal/v1/frappe/transactions/delivery-note"))
  assert.ok(routePaths.includes("POST /internal/v1/frappe/transactions/invoice"))
  assert.ok(routePaths.includes("POST /internal/v1/frappe/transactions/return"))
  assert.ok(routePaths.includes("GET /internal/v1/frappe/contracts/item-projection"))
  assert.ok(routePaths.includes("GET /internal/v1/frappe/contracts/price-projection"))
  ...
  assert.ok(routePaths.includes("DELETE /internal/v1/frappe/todos"))
...
test("internal route registry includes the billing voucher and report endpoints", () => {
  ...
  assert.ok(routePaths.includes("GET /internal/v1/billing/purchase-receipts"))
  assert.ok(routePaths.includes("GET /internal/v1/billing/purchase-receipt"))
  assert.ok(routePaths.includes("POST /internal/v1/billing/purchase-receipts"))
  assert.ok(routePaths.includes("PATCH /internal/v1/billing/purchase-receipt"))
  assert.ok(routePaths.includes("GET /internal/v1/billing/goods-inward-notes"))
  assert.ok(routePaths.includes("GET /internal/v1/billing/goods-inward-note"))
  assert.ok(routePaths.includes("POST /internal/v1/billing/goods-inward-notes"))
  assert.ok(routePaths.includes("PATCH /internal/v1/billing/goods-inward-note"))
  assert.ok(routePaths.includes("POST /internal/v1/billing/goods-inward-note/post"))
  assert.ok(routePaths.includes("GET /internal/v1/billing/stock-units"))
  assert.ok(routePaths.includes("GET /internal/v1/billing/stock-unit"))
  assert.ok(routePaths.includes("POST /internal/v1/billing/stock/barcode/resolve"))
  assert.ok(routePaths.includes("POST /internal/v1/billing/stock/sticker-batches"))
  assert.ok(routePaths.includes("GET /internal/v1/billing/stock/sale-allocations"))
  assert.ok(routePaths.includes("POST /internal/v1/billing/stock/sale-allocations"))
...
test("internal route registry includes the core common-module CRUD endpoints", () => {
  ...
  assert.ok(routePaths.includes("GET /internal/v1/framework/hosted-apps"))
  assert.ok(routePaths.includes("POST /internal/v1/framework/hosted-apps/update-clean"))
  assert.ok(routePaths.includes("GET /internal/v1/framework/remote-servers"))
  assert.ok(routePaths.includes("POST /internal/v1/framework/remote-servers"))
  assert.ok(routePaths.includes("GET /internal/v1/framework/remote-server"))
  assert.ok(routePaths.includes("POST /internal/v1/framework/remote-server/git-update"))
  assert.ok(routePaths.includes("POST /internal/v1/framework/remote-server-secret/generate"))
  assert.ok(routePaths.includes("POST /internal/v1/framework/remote-server/generate-secret"))
  assert.ok(routePaths.includes("DELETE /internal/v1/framework/remote-server"))
  assert.ok(routePaths.includes("POST /internal/v1/framework/developer-operations"))
  ...
  assert.ok(routePaths.includes("GET /internal/v1/ecommerce/overview-report"))
  assert.ok(routePaths.includes("GET /internal/v1/ecommerce/analytics/attribution-report"))
  assert.ok(routePaths.includes("GET /internal/v1/ecommerce/inventory/multi-warehouse-readiness"))
  assert.ok(routePaths.includes("GET /internal/v1/ecommerce/advanced-commerce/recommendations"))
  assert.ok(routePaths.includes("GET /internal/v1/ecommerce/advanced-commerce/segments"))
  assert.ok(routePaths.includes("GET /internal/v1/ecommerce/advanced-commerce/lifecycle-marketing"))
  assert.ok(routePaths.includes("GET /internal/v1/ecommerce/advanced-commerce/merchandising"))
  assert.ok(routePaths.includes("GET /internal/v1/ecommerce/support/report"))
  assert.ok(routePaths.includes("GET /internal/v1/ecommerce/order-requests/report"))
  assert.ok(routePaths.includes("GET /internal/v1/ecommerce/rma/report"))
  assert.ok(routePaths.includes("GET /internal/v1/ecommerce/orders/report"))
  assert.ok(routePaths.includes("GET /internal/v1/ecommerce/order"))
  assert.ok(routePaths.includes("POST /internal/v1/ecommerce/order/action"))
  assert.ok(routePaths.includes("POST /internal/v1/ecommerce/support/case"))
  assert.ok(routePaths.includes("POST /internal/v1/ecommerce/order-request/review"))
  ...
  assert.ok(routePaths.includes("GET /internal/v1/ecommerce/payments/aging-report"))
  assert.ok(routePaths.includes("GET /internal/v1/ecommerce/payments/accounting-compatibility-report"))
