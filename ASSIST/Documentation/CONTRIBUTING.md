...
11. new framework runtime modules must add matching docs under `ASSIST/Documentation`
...
11. If a change adds a new module or package, mention the matching docs path under `ASSIST/Documentation`.
